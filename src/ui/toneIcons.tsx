...
/**
 * `0` is the neutral-tone sentinel (see `words.ts`/`gates.ts` — a syllable
 * with no real pitch target). Drawn as a plain dot, matching the other
 * marks' stroke weight, not traced from any tone-contour recording.
 */
export type ToneOrNeutral = Tone | 0;

/** Exported for the share card (`src/share/renderCard.ts`), which draws these onto canvas via Path2D. */
...
export function ToneMarkIcon({ tone, className }: { tone: ToneOrNeutral; className?: string }) {
  return (
...
/** Visualiser's mute toggle, live state — traced from `src/ui/icons/microphone.svg`. */
export function MicrophoneIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 256 256" className={className} aria-hidden="true">
      <rect x="88" y="24" width="80" height="144" rx="40" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="16" />
      <line x1="128" y1="200" x2="128" y2="240" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="16" />
      <path d="M200,128a72,72,0,0,1-144,0" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="16" />
    </svg>
  );
}

/** Visualiser's mute toggle, muted state — traced from `src/ui/icons/microphone-slash.svg`. */
export function MicrophoneSlashIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 256 256" className={className} aria-hidden="true">
      <line x1="128" y1="200" x2="128" y2="240" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="16" />
      <line x1="48" y1="48" x2="208" y2="224" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="16" />
      <path d="M172.32,184.75A72,72,0,0,1,56,128" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="16" />
      <path d="M200,128a71.7,71.7,0,0,1-7.29,31.61" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="16" />
      <path d="M150.68,161A39.77,39.77,0,0,1,128,168h0a40,40,0,0,1-40-40V92" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="16" />
      <path d="M91.3,48.06A40,40,0,0,1,128,24h0a40,40,0,0,1,40,40v64a38.66,38.66,0,0,1-.22,4.19" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="16" />
    </svg>
  );
}
